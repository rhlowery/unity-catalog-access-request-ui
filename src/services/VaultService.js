...
export const VaultService = {
     ...
     * @param {string} fullPath - The path to the secret (e.g., 'secret/data/my-app')
     * @param {string} key - The JSON key representing the value to retrieve.
     */
    async fetchSecret(fullPath, key) {
        ...
        try {
            ...
            // For simplicity, we assume the user provides the "api path" or we try to just append.
            ...
            // Use the proxy if we have CORS issues, but typically Vault allows CORS if configured.
